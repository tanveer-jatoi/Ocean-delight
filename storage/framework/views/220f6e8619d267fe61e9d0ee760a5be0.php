<?php $__env->startSection('title', '404 - Page Not Found | Ocean Delight'); ?>
...
<div class="container" style="padding-top: 5rem; padding-bottom: 5rem; text-align: center;">
    ...
    <a href="<?php echo e(route('home')); ?>" class="btn btn-ocean">Return to Homepage</a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Ocean-Delight\resources\views/errors/404.blade.php ENDPATH**/ ?>