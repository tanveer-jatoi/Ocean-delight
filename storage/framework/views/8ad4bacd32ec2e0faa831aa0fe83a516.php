...
<section class="hero-section">
    ...
    <div class="container hero-content">
        ...
        <div class="hero-btn-group">
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-sand">Shop Now &rarr;</a>
...
<div class="container">
    <div class="filter-search-bar">
        <form action="<?php echo e(route('products.index')); ?>" method="GET" class="search-input-group">
        ...
        <div class="category-pills">
            <a href="<?php echo e(route('products.index')); ?>" class="pill-item active">All Seafood</a>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('category.show', $cat->slug)); ?>" class="pill-item"><?php echo e($cat->name); ?></a>
...
<section style="padding: 4rem 0;" id="finest-catch">
    <div class="container">
        <div class="section-header">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-sm btn-ocean">View All Products &rarr;</a>
        </div>
