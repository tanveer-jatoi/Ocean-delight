<footer class="site-footer">
    <div class="container">
        <div class="footer-grid">
            <div>
                <a href="<?php echo e(route('home')); ?>" class="logo-brand logo-brand-footer" style="margin-bottom: 1rem; display: inline-flex; text-decoration: none;" aria-label="Ocean Delight Fresh Seafood">
